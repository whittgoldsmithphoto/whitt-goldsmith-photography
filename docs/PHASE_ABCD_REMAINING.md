...
- Real authenticated R2 download streaming/short-lived delivery, failed-delivery accounting and buyer entitlement-expiry/revocation tests. No customer original-download handler is exposed by the new foundation yet.
